...
ROOT = '~/OneDrive/Documents/Academic Records/College/Semester 4/Machine Learning/HW 3'
...
def main(args):
    ...
    if args.keras:
        ...
        model.add(Dense(units=50, activation='relu', name='Hidden_Layer_1')) # Hidden layer 1 has 5 neurons
        ...
        if args.save:
            print('Saving Keras Neural Network Weights to File...')
